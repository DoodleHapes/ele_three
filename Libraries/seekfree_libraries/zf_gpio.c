...
void gpio_init(void)
{
	...
	gpio_pull_set(P2_0,PULLUP);
	gpio_pull_set(P7_6,PULLUP);
	gpio_pull_set(P2_1,PULLUP);
	gpio_pull_set(P4_4,PULLUP);
	gpio_pull_set(P4_0,PULLUP);
	gpio_pull_set(P6_6,PULLUP);
	gpio_mode(P7_5,GPI_OD);
	gpio_mode(P2_0,GPI_OD);
	gpio_mode(P7_6,GPI_OD);
	gpio_mode(P2_1,GPI_OD);
	gpio_mode(P4_4,GPI_OD);
	gpio_mode(P4_0,GPI_OD);
	gpio_mode(P6_6,GPI_OD);
}
